...
class GameController extends AbstractController
{
    ...
    {
        return $this->render('game/parties.html.twig', array(
    ...
    public function classement(Request $request, $page)
    {
        ...
        return $this->render('game/classement.html.twig', array(
            'order' => $order,
            'filter' => $filter,
    ...
    {
        return $this->render('game/games/recentList.html.twig', array(
    ...
    public function signature(User $user, GameData $gameData)
    {
        ...
        return $this->render('game/signature.html.twig', array('user' => $user));
    }
}
